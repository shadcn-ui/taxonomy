...
export default async function IndexPage() {
    ...
    const [landscape, character, character2] = await Promise.all([
        pixelateImage({
            remoteUrl:
                "https://replicate.delivery/pbxt/yQ6N3UuY7gJoHRPjqofBIQF1NL1aKVEE4yg41UfprSSDIj1QA/out-0.png",
        }),
        pixelateImage({
            remoteUrl:
                "https://cdn.cloud.scenario.com/assets/GWhqIizWSSGcMc_3iIQBEg?p=100&Expires=1683504000&Key-Pair-Id=K36FIAB9LE2OLR&Signature=lTn0sur1D55Qi3GTbbsfl6jpFA17~Vq1oWhjb2Ap0OwdeQbKWDh9zZslP3SarPPZgYXvZQBR-4PtOZV~P7NwDPpFzWrVrqKaeD4CDTpArB-bAuGfYPqeovBuNIYTRJmktRk1C-b1wlVbwWCSjTK0luiXp6M6LiVha01cw--vNWjMWCIK~w-Dy-cmteCe48Nor9TOLSNV~eHlnCfTsP6kIVNHyeIGIbCMQQLSwBeHYpcucIhMIdjWZOBqiGUzX8UWcqnk6HKu9M8gJvx4PDlQiXlK~ohYDOgaDuLv4HQxNljdbuPr6nkP3kqlM6q~DZU61A5~7Bg5Sf77wrcuNyQlQA__",
        }),
        pixelateImage({
            remoteUrl:
                "https://cdn.cloud.scenario.com/inferences/bbqzwEdGRaCOeUec0cq7vA/results/3583688960967331/050.png?Expires=1683504000&Key-Pair-Id=K36FIAB9LE2OLR&Signature=iUckkhIP6zUvG17dtqCgcxX3VP5yEAAVCYp9mKPd-qzUYR8v8oCffDbY2Eu8H3ykpkfqKiy3bvBI9xqq0E-w0KFt4n29wmKcQQ2k-TEubyhZxeUFZDQro8V0cfdlChrliIMvtLBIH6IGM3Ojwvi~QTYGsEMiGjDBDkkRgTcaLnz0HcgnMIYLC-hu570GCB1PVoxncssAkkc8yXxPf4zHtzsWZ57HEu4IzpRczALuOjT4oC3ew0goFG-KzqvxJH1Mdpy3tiTxiSsOvjfBMASkW1JMoZq3sV6HhmKYGzHr3~MqcbvU-RgUiLvwVTTkgKHyB83ndXvQxWlEr3hM-0Fdew__",
        }),
    ])
        ...
        <>
            ...
            >
                <div className="grid grid-cols-3 gap-4">
                    <Card>
                        <CardHeader>
                            <CardTitle>Landscape Portraits</CardTitle>
                            <CardDescription>
                                Waterfall in beautiful oasis
                            </CardDescription>
                        </CardHeader>
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle>Fantasy Character Portraits</CardTitle>
                            <CardDescription>
