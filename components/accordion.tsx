...
const Accordion: FC<AccordionProps> = ({ title, items }) => (
    <div className="bg-gray-50 p-4">
          <Link href='/support' ><button type='button' className="inline-flex items-center"><HiArrowLeft className="-ml-1 mr-2 h-5 w-5 relative inline-flex items-center" aria-hidden="true" /> Back </button></Link>
